        ...
        <div className="space-y-8 pb-32 pt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4">
                ...
                <section>
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-4 flex gap-4 items-center shadow-sm h-full">
                ...
                <section>
                    ...
                    <Card variant="outlined" className="p-5 shadow-sm h-full">
            ...
            <section className="px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {['WOOD', 'IRON', 'WEDGE', 'PUTTER'].map((category) => {
                        ...
                        return (
                            <div key={category} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm h-full">
